...
if test "$PHP_STRIBOG" = "yes"; then
	...
	PHP_NEW_EXTENSION([stribog], [stribog.c tables.c gost3411-2012.c gost3411-2012-ref.c gost3411-2012-mmx.c gost3411-2012-sse2.c gost3411-2012-sse41.c], $ext_shared)
